    ...
    return function n(i, o, a) {
        ...
        2: [function(e, t, r) {
                    ...
                    switch (n.browser) {
                        case "chrome":
                            ...
                            r("adapter.js shimming chrome."),
                                i.browserShim = s,
                                u.shimAddIceCandidateNullOrEmpty(e, n),
                                u.shimParameterlessSetLocalDescription(e, n),
                                s.shimGetUserMedia(e, n),
                                s.shimMediaStream(e, n),
                                s.shimPeerConnection(e, n),
                                s.shimOnTrack(e, n),
                                s.shimAddTrackRemoveTrack(e, n),
                                s.shimGetSendersWithDtmf(e, n),
                                s.shimGetStats(e, n),
                                s.shimSenderReceiverGetStats(e, n),
                                s.fixNegotiationNeeded(e, n),
                                u.shimRTCIceCandidate(e, n),
                                u.shimRTCIceCandidateRelayProtocol(e, n),
                                u.shimConnectionState(e, n),
                                u.shimMaxMessageSize(e, n),
                                u.shimSendThrowTypeError(e, n),
                                u.removeExtmapAllowMixed(e, n);
                            break;
                        case "firefox":
                            ...
                            r("adapter.js shimming firefox."),
                                ...
                                u.shimAddIceCandidateNullOrEmpty(e, n),
                                u.shimParameterlessSetLocalDescription(e, n),
                                c.shimGetUserMedia(e, n),
                                c.shimPeerConnection(e, n),
                                c.shimOnTrack(e, n),
                                c.shimRemoveStream(e, n),
                                c.shimSenderGetStats(e, n),
                                c.shimReceiverGetStats(e, n),
                                c.shimRTCDataChannel(e, n),
                                c.shimAddTransceiver(e, n),
                                c.shimGetParameters(e, n),
                                c.shimCreateOffer(e, n),
                                c.shimCreateAnswer(e, n),
                                u.shimRTCIceCandidate(e, n),
                                u.shimConnectionState(e, n),
                                u.shimMaxMessageSize(e, n),
                                u.shimSendThrowTypeError(e, n);
                        ...
                        case "safari":
                            ...
                            r("adapter.js shimming safari."),
                                ...
                                u.shimAddIceCandidateNullOrEmpty(e, n),
                                u.shimParameterlessSetLocalDescription(e, n),
                                p.shimRTCIceServerUrls(e, n),
                                p.shimCreateOfferLegacy(e, n),
                                p.shimCallbacksAPI(e, n),
                                p.shimLocalStreamsAPI(e, n),
                                p.shimRemoteStreamsAPI(e, n),
                                p.shimTrackEventTransceiver(e, n),
                                p.shimGetUserMedia(e, n),
                                p.shimAudioContext(e, n),
                                u.shimRTCIceCandidate(e, n),
                                u.shimRTCIceCandidateRelayProtocol(e, n),
                                u.shimMaxMessageSize(e, n),
                                u.shimSendThrowTypeError(e, n),
            ...
            function n(e, t) {
                ...
                if (t && t.has(e))
                    return t.get(e);
                var r, n, i = {}, o = Object.defineProperty && Object.getOwnPropertyDescriptor;
                for (r in e)
                    "default" !== r && Object.prototype.hasOwnProperty.call(e, r) && ((n = o ? Object.getOwnPropertyDescriptor(e, r) : null) && (n.get || n.set) ? Object.defineProperty(i, r, n) : i[r] = e[r]);
                return i.default = e,
                t && t.set(e, i),
                    i
            }
        ...
        3: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.fixNegotiationNeeded = function(e, r) {
                    i.wrapPeerConnectionEvent(e, "negotiationneeded", function(e) {
                        var t = e.target;
                        if (!(r.version < 72 || t.getConfiguration && "plan-b" === t.getConfiguration().sdpSemantics) || "stable" === t.signalingState)
                            return e
                    })
                }
                ,
                r.shimAddTrackRemoveTrack = function(i, e) {
                    if (i.RTCPeerConnection) {
                        ...
                        var r = i.RTCPeerConnection.prototype.getLocalStreams
                            ...
                            this._reverseStreams[e.id] || (t = new i.MediaStream(e.getTracks()),
                            ...
                            return arguments.length && arguments[0].type && (arguments[0] = (r = this,
                                n = (e = arguments[0]).sdp,
                        ...
                        Object.defineProperty(i.RTCPeerConnection.prototype, "localDescription", {
                            ...
                            i.RTCPeerConnection.prototype.removeTrack = function(t) {
                                ...
                                r && (1 === r.getTracks().length ? this.removeStream(this._reverseStreams[r.id]) : r.removeTrack(t.track),
                ...
                r.shimGetSendersWithDtmf = function(e) {
                    {
                        ...
                        ) : "object" === s(e) && e.RTCPeerConnection && "getSenders"in e.RTCPeerConnection.prototype && "createDTMFSender"in e.RTCPeerConnection.prototype && e.RTCRtpSender && !("dtmf"in e.RTCRtpSender.prototype) && (a = e.RTCPeerConnection.prototype.getSenders,
                ...
                r.shimGetStats = function(e) {
                    var a;
                    e.RTCPeerConnection && (a = e.RTCPeerConnection.prototype.getStats,
                            e.RTCPeerConnection.prototype.getStats = function() {
                                ...
                                if (0 === a.length && (0 === arguments.length || "function" != typeof t))
                                    return a.apply(this, []);
                                var i = function(e) {
                                    var n = {};
                ...
                r.shimSenderReceiverGetStats = function(e) {
                    ...
                    "getStats"in e.RTCRtpSender.prototype && "getStats"in e.RTCRtpReceiver.prototype && (o = e.RTCPeerConnection.prototype.getStats,
                            e.RTCPeerConnection.prototype.getStats = function() {
                                var t, r, n, i;
                                return 0 < arguments.length && arguments[0]instanceof e.MediaStreamTrack ? (t = arguments[0],
            ...
            var i = function(e, t) {
                ...
                if (t && t.has(e))
                    return t.get(e);
                var r, n = {}, i = Object.defineProperty && Object.getOwnPropertyDescriptor;
                for (r in e) {
                    var o;
            ...
            function p(e) {
                ...
                var n = e.RTCPeerConnection.prototype.addTrack
                    ...
                    return this._shimmedLocalStreams[t.id] ? -1 === this._shimmedLocalStreams[t.id].indexOf(r) && this._shimmedLocalStreams[t.id].push(r) : this._shimmedLocalStreams[t.id] = [t, r],
                        r
                }
                    ,
                    ...
                    var r = this
                        , t = (this._shimmedLocalStreams = this._shimmedLocalStreams || {},
                        e.getTracks().forEach(function(t) {
                            if (r.getSenders().find(function(e) {
                                return e.track === t
                            }))
                        ...
                        this.getSenders().filter(function(e) {
                ...
                e.RTCPeerConnection.prototype.removeTrack = function(r) {
                    var n = this;
                    return this._shimmedLocalStreams = this._shimmedLocalStreams || {},
                    r && Object.keys(this._shimmedLocalStreams).forEach(function(e) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.shimGetUserMedia = function(e, t) {
                    ...
                    s.mediaDevices && (a = function(i) {
                        if ("object" !== c(i) || i.mandatory || i.optional)
                            return i;
                        var o = {};
                        return Object.keys(i).forEach(function(t) {
                            ...
                            "require" !== t && "advanced" !== t && "mediaSource" !== t && (void 0 !== (r = "object" === c(i[t]) ? i[t] : {
                                ...
                                ,
                            void 0 !== r.ideal && (o.optional = o.optional || [],
                                e = {},
                                "number" == typeof r.ideal ? (e[n("min", t)] = r.ideal,
                                    o.optional.push(e),
                                    (e = {})[n("max", t)] = r.ideal) : e[n("", t)] = r.ideal,
                                o.optional.push(e)),
                                void 0 !== r.exact && "number" != typeof r.exact ? (o.mandatory = o.mandatory || {},
                                    o.mandatory[n("", t)] = r.exact) : ["min", "max"].forEach(function(e) {
                                    void 0 !== r[e] && (o.mandatory = o.mandatory || {},
                        ...
                        n = function(r, n) {
                            ...
                            )((r = JSON.parse(JSON.stringify(r))).audio, "autoGainControl", "googAutoGainControl"),
                            ...
                            r && "object" === c(r.video)) {
                                ...
                                if (o && ("user" === o.exact || "environment" === o.exact || "user" === o.ideal || "environment" === o.ideal) && (!s.mediaDevices.getSupportedConstraints || !s.mediaDevices.getSupportedConstraints().facingMode || e))
                                    if (delete r.video.facingMode,
                                        "environment" === o.exact || "environment" === o.ideal ? i = ["back", "rear"] : "user" !== o.exact && "user" !== o.ideal || (i = ["front"]),
                                        i)
                            ...
                            return p("chrome: " + JSON.stringify(r)),
                                n(r)
                        }
                        ,
                        i = function(e) {
                        ...
                        s.getUserMedia = function(e, t, r) {
                            ...
                            .bind(s),
                    s.mediaDevices.getUserMedia && (r = s.mediaDevices.getUserMedia.bind(s.mediaDevices),
        ...
        6: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.removeExtmapAllowMixed = function(r, e) {
                    var n;
                    !r.RTCPeerConnection || "chrome" === e.browser && 71 <= e.version || "safari" === e.browser && 605 <= e.version || (n = r.RTCPeerConnection.prototype.setRemoteDescription,
                            r.RTCPeerConnection.prototype.setRemoteDescription = function(e) {
                                var t;
                ...
                r.shimConnectionState = function(e) {
                    var r;
                    !e.RTCPeerConnection || "connectionState"in e.RTCPeerConnection.prototype || (r = e.RTCPeerConnection.prototype,
                        ...
                        ["setLocalDescription", "setRemoteDescription"].forEach(function(e) {
                            ...
                            r[e] = function() {
                                return this._connectionstatechangepoly || (this._connectionstatechangepoly = function(e) {
                                    var t, r = e.target;
                                    return r._lastConnectionState !== r.connectionState && (r._lastConnectionState = r.connectionState,
                ...
                r.shimMaxMessageSize = function(e, o) {
                    ...
                    e.RTCPeerConnection && ("sctp"in e.RTCPeerConnection.prototype || Object.defineProperty(e.RTCPeerConnection.prototype, "sctp", {
                            ...
                            e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                                ...
                                "chrome" === o.browser && 76 <= o.version && "plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                                    get: function() {
                                        return void 0 === this._sctp ? null : this._sctp
                                    },
                                    enumerable: !0,
                                ...
                                function(e) {
                                    ...
                                    n = t,
                                    i = 65536,
                                    n = i = "firefox" === o.browser ? o.version < 57 ? -1 === n ? 16384 : 2147483637 : o.version < 60 ? 57 === o.version ? 65535 : 65536 : 2147483637 : i,
                                    i = arguments[0],
                                    t = t,
                                    r = 65536,
                                "firefox" === o.browser && 57 === o.version && (r = 65535),
                                    0 < (i = s.default.matchPrefix(i.sdp, "a=max-message-size:")).length ? r = parseInt(i[0].substring(19), 10) : "firefox" === o.browser && -1 !== t && (r = 2147483637),
                                    i = r,
                                    e = 0 === n && 0 === i ? Number.POSITIVE_INFINITY : 0 === n || 0 === i ? Math.max(n, i) : Math.min(n, i),
                                    t = {},
                ...
                r.shimRTCIceCandidate = function(t) {
                    var i;
                    !t.RTCIceCandidate || t.RTCIceCandidate && "foundation"in t.RTCIceCandidate.prototype || (i = t.RTCIceCandidate,
                        t.RTCIceCandidate = function(e) {
                            if ("object" === c(e) && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substring(2)),
                            e.candidate && e.candidate.length) {
                                var t, r = new i(e), n = s.default.parseCandidate(e.candidate);
                                for (t in n)
                ...
                r.shimSendThrowTypeError = function(e) {
                    ...
                    function r(t, r) {
                        ...
                        t.send = function() {
                            ...
                            if ("open" === t.readyState && r.sctp && e > r.sctp.maxMessageSize)
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.shimAddTransceiver = function(e) {
                    ...
                    "object" !== c(e) || !e.RTCPeerConnection || (i = e.RTCPeerConnection.prototype.addTransceiver) && (e.RTCPeerConnection.prototype.addTransceiver = function() {
                            ...
                            var e, t = arguments[1] && arguments[1].sendEncodings, r = 0 < (t = function(e) {
                                if (Array.isArray(e))
                                    return s(e)
                            ...
                            }()).length, n = (r && t.forEach(function(e) {
                                if ("rid"in e)
                            ...
                            return !r || "encodings"in (r = (e = n.sender).getParameters()) && (1 !== r.encodings.length || 0 !== Object.keys(r.encodings[0]).length) || (r.encodings = t,
                                e.sendEncodings = t,
                                this.setParametersPromises.push(e.setParameters(r).then(function() {
                ...
                r.shimCreateAnswer = function(e) {
                    var r;
                    "object" === c(e) && e.RTCPeerConnection && (r = e.RTCPeerConnection.prototype.createAnswer,
                ...
                r.shimCreateOffer = function(e) {
                    var r;
                    "object" === c(e) && e.RTCPeerConnection && (r = e.RTCPeerConnection.prototype.createOffer,
                ...
                r.shimPeerConnection = function(n, i) {
                    var o, r;
                    "object" === c(n) && (n.RTCPeerConnection || n.mozRTCPeerConnection) && (!n.RTCPeerConnection && n.mozRTCPeerConnection && (n.RTCPeerConnection = n.mozRTCPeerConnection),
                        i.version < 53 && ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function(e) {
                            ...
                            r = n.RTCPeerConnection.prototype.getStats,
                ...
                r.shimGetDisplayMedia = function(t, r) {
                    t.navigator.mediaDevices && "getDisplayMedia"in t.navigator.mediaDevices || t.navigator.mediaDevices && (t.navigator.mediaDevices.getDisplayMedia = function(e) {
                            return e && e.video ? (!0 === e.video ? e.video = {
                                ...
                                t.navigator.mediaDevices.getUserMedia(e)) : ((e = new DOMException("getDisplayMedia without video constraints is undefined")).name = "NotFoundError",
                                e.code = 8,
                                Promise.reject(e))
                        }
                    )
                ...
                r.shimGetUserMedia = function(e, t) {
                        ...
                        , e = e && e.MediaStreamTrack;
                    {
                        ...
                        n.getUserMedia = function(e, t, r) {
                            s.deprecated("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"),
                        ...
                        55 < t.version && "autoGainControl"in n.mediaDevices.getSupportedConstraints() || (r = function(e, t, r) {
                            ...
                            n.mediaDevices.getUserMedia = function(e) {
                                return "object" === c(e) && "object" === c(e.audio) && (e = JSON.parse(JSON.stringify(e)),
                                    r(e.audio, "autoGainControl", "mozAutoGainControl"),
                                    r(e.audio, "noiseSuppression", "mozNoiseSuppression")),
                                    i(e)
                            }
                            ,
                        e && e.prototype.getSettings && (o = e.prototype.getSettings,
                                e.prototype.getSettings = function() {
                                    var e = o.apply(this, arguments);
                                    return r(e, "mozAutoGainControl", "autoGainControl"),
                                        r(e, "mozNoiseSuppression", "noiseSuppression"),
                                        e
                                }
                        ),
                        e && e.prototype.applyConstraints && (a = e.prototype.applyConstraints,
                                e.prototype.applyConstraints = function(e) {
                                    return "audio" === this.kind && "object" === c(e) && (e = JSON.parse(JSON.stringify(e)),
                                        r(e, "autoGainControl", "mozAutoGainControl"),
                                        r(e, "noiseSuppression", "mozNoiseSuppression")),
                                        a.apply(this, [e])
                                }
                        ))
                    }
        ...
        10: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.shimCallbacksAPI = function(e) {
                    var n, i, o, a, s, t;
                    "object" === c(e) && e.RTCPeerConnection && (e = e.RTCPeerConnection.prototype,
                        n = e.createOffer,
                        i = e.createAnswer,
                        o = e.setLocalDescription,
                        a = e.setRemoteDescription,
                        s = e.addIceCandidate,
                ...
                r.shimLocalStreamsAPI = function(e) {
                    ...
                    "addStream"in e.RTCPeerConnection.prototype || (o = e.RTCPeerConnection.prototype.addTrack,
                            ...
                            e.RTCPeerConnection.prototype.addTrack = function(e) {
                                for (var t = this, r = arguments.length, n = new Array(1 < r ? r - 1 : 0), i = 1; i < r; i++)
                                    n[i - 1] = arguments[i];
                    ...
                    "removeStream"in e.RTCPeerConnection.prototype || (e.RTCPeerConnection.prototype.removeStream = function(e) {
                            var t, r = this, n = (this._localStreams || (this._localStreams = []),
                                this._localStreams.indexOf(e));
                ...
                r.shimRTCIceServerUrls = function(e) {
                    var o;
                    e.RTCPeerConnection && (o = e.RTCPeerConnection,
                        e.RTCPeerConnection = function(e, t) {
                            if (e && e.iceServers) {
                                for (var r = [], n = 0; n < e.iceServers.length; n++) {
                                    var i = e.iceServers[n];
                                    void 0 === i.urls && i.url ? (a.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
                                        (i = JSON.parse(JSON.stringify(i))).urls = i.url,
                                        delete i.url,
                                        r.push(i)) : r.push(e.iceServers[n])
                                }
                                e.iceServers = r
                            }
                            return new o(e,t)
                    ...
                    "generateCertificate"in o && Object.defineProperty(e.RTCPeerConnection, "generateCertificate", {
                        get: function() {
                                ...
                                this._onaddstream && (this.removeEventListener("addstream", this._onaddstream),
                                    ...
                                    this.addEventListener("track", this._onaddstreampoly = function(e) {
                                            e.streams.forEach(function(e) {
                                                ...
                                                r._remoteStreams.includes(e) || (r._remoteStreams.push(e),
                            ...
                            e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                                ...
                                return this._onaddstreampoly || this.addEventListener("track", this._onaddstreampoly = function(e) {
                                        e.streams.forEach(function(e) {
                                            var t;
                                            r._remoteStreams || (r._remoteStreams = []),
                                            0 <= r._remoteStreams.indexOf(e) || (r._remoteStreams.push(e),
                                                (t = new Event("addstream")).stream = e,
                                                r.dispatchEvent(t))
                                        })
                                    }
        ...
        11: [function(e, t, r) {
            ...
            Object.defineProperty(r, "__esModule", {
                ...
                r.disableWarnings = function(e) {
                    ...
                    "adapter.js deprecation warnings " + (e ? "disabled" : "enabled")) : new Error("Argument type: " + n(e) + ". Please use a boolean.")
                }
                ,
                r.extractVersion = s,
                    ...
                    e.RTCPeerConnection && (e = e.RTCPeerConnection.prototype,
                        ...
                        e.removeEventListener = function(e, t) {
                            if (e !== n || !this._eventMap || !this._eventMap[n])
                                return a.apply(this, arguments);
                            if (!this._eventMap[n].has(t))
                                return a.apply(this, arguments);
                            var r = this._eventMap[n].get(t);
                            return this._eventMap[n].delete(t),
        ...
        12: [function(e, t, r) {
            ...
            p.localCName = p.generateIdentifier(),
                ...
                p.writeCandidate = function(e) {
                    var t = []
                        , r = (t.push(e.foundation),
                        e.component)
                        , r = ("rtp" === r ? t.push(1) : "rtcp" === r ? t.push(2) : t.push(r),
                ...
                p.writeRtpMap = function(e) {
                    var t = e.payloadType
                        , r = (void 0 !== e.preferredPayloadType && (t = e.preferredPayloadType),
                    e.channels || e.numChannels || 1);
                ...
                p.writeFmtp = function(t) {
                    var r, e = "", n = t.payloadType;
                    return void 0 !== t.preferredPayloadType && (n = t.preferredPayloadType),
                    t.parameters && Object.keys(t.parameters).length && (r = [],
                ...
                p.parseSsrcMedia = function(e) {
                    var t = e.indexOf(" ")
                        ...
                        , n = e.indexOf(":", t);
                    return -1 < n ? (r.attribute = e.substring(t + 1, n),
                ...
                p.parseRtpParameters = function(e) {
                    ...
                    for (var n = 3; n < r.length; n++) {
                        ...
                        if (o) {
                            ...
                            switch (a.parameters = o.length ? p.parseFmtp(o[0]) : {},
                                a.rtcpFeedback = p.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(p.parseRtcpFb),
                                t.codecs.push(a),
                                a.name.toUpperCase()) {
                                case "RED":
                                case "ULPFEC":
                ...
                p.parseRtpEncodingParameters = function(e) {
                    var t = []
                        ...
                        , c = (0 < o.length && 1 < o[0].length && o[0][0] === a && (s = o[0][1]),
                        r.codecs.forEach(function(e) {
                            ...
                            a && s && (e.rtx = {
                                ...
                                t.push(e),
                            n && ((e = JSON.parse(JSON.stringify(e))).fec = {
                                ssrc: a,
                    ...
                    0 === t.length && a && t.push({
                        ...
                        p.matchPrefix(e, "b="));
                    return c.length && (c = 0 === c[0].indexOf("b=TIAS:") ? parseInt(c[0].substring(7), 10) : 0 === c[0].indexOf("b=AS:") ? 1e3 * parseInt(c[0].substring(5), 10) * .95 - 16e3 : void 0,
                ...
                p.parseRtcpParameters = function(e) {
                    var t = {}
                        ...
                        , r = (r && (t.cname = r.value,
                        t.ssrc = r.ssrc),
                        p.matchPrefix(e, "a=rtcp-rsize"))
                        , r = (t.reducedSize = 0 < r.length,
                        t.compound = 0 === r.length,
                        p.matchPrefix(e, "a=rtcp-mux"));
                    return t.mux = 0 < r.length,
                        t
                }
                ,
                ...
                p.parseSctpDescription = function(e) {
                    var t = p.parseMLine(e)
                        ...
                        , n = void 0
                        , r = (0 < r.length && (n = parseInt(r[0].substring(19), 10)),
                    isNaN(n) && (n = 65536),
                        p.matchPrefix(e, "a=sctp-port:"));
                    if (0 < r.length)
                        return {
